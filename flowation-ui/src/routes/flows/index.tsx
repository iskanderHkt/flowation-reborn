...
function sortFlows(flows: Flow[], field: SortField, dir: SortDir): Flow[] {
  if (!dir) return flows
...
export function FlowsPage() {
  ...
  const sorted = useMemo(
    () => sortFlows(filtered, sortField, sortDir),
    ...
    <div className="p-6 max-w-7xl">
      ...
      <div className="mb-6">
        ...
        <p className="text-xs text-[var(--color-text-muted)] mt-0.5">
          Compose operations into sequential test pipelines
        </p>
      </div>
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <Link to="/flows/new" className="ml-auto">
          <Button size="sm">
            <Plus size={14} />
            New Flow
          </Button>
              ...
              <tbody>
                {paginated.map((flow) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 text-[var(--color-text-muted)] text-xs max-w-xs truncate">
                      {flow.description || '\u2014'}
                    </td>
                      ...
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <ConfirmPopover
                          ...
                          onConfirm={() => deleteMutation.mutate(flow.id, {
                            onSuccess: () => toast({ title: `Deleted "${flow.name}"`, variant: 'success' }),
